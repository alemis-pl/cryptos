...
@Slf4j
@Component
public class BitfinexExchangeAuthenticationSpring {
    ...
    @Autowired
    public BitfinexExchangeAuthenticationSpring(DbService dbService, HmacEncoder hmacEncoder, ContentGenerator contentGenerator, RestTemplate restTemplate, BitfinexRequestParamsModifier requestParamsModifier) {
