...
@Component
public class BitfinexRequestParamsModifier {
    ...
    public Map<String, Object> modifyRequestParamMap(BitfinexParamsModerator paramsModerator) {
    ...
    private HashMap<String, Object> createRequestParam(BitfinexParamsModerator paramsModerator) {
        HashMap<String, Object> createRequestParam = new HashMap<>();
    ...
    private HashMap<String, Object> createReqeustParamForBalanceHistory(BitfinexParamsModerator paramsModerator) {
        HashMap<String, Object> createRequestParam = new HashMap<>();
    ...
    private HashMap<String,Object> createRequestParamsForNewOrder(BitfinexParamsModerator paramsModerator) {
